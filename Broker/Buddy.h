...
void particionar_bloque_buddies(t_bloque_memoria* particion,t_mensaje_cola* estructura_mensaje, int tamanio_bytes_pot_dos); // EN PROCESO
void reemplazar_bloque_BS(t_mensaje_cola* estructura_mensaje); //EN PROCESO
